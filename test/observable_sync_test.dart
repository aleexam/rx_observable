...
void main() {
  group('Basic Functionality', () {
    test('initial value is set and updates correctly', () {
      ...
      expect(obs.value, equals(42));
      expect(obs.v, equals(42));

      obs.value = 43;
      expect(obs.value, equals(43));
    });
  ...
  group('Listeners and Subscriptions', () {
    test('listen callback with and without fireImmediately', () {
      ...
      expect(lastValue2, equals(42));

      obs.value = 43;
      expect(lastValue1, equals(43));
      expect(lastValue2, equals(43));
    });
  ...
  group('Compatibility with ChangeNotifier', () {
    ...
    test('Observable implements ValueListenable', () {
      ...
      expect(valueFromListenable, equals(42));
      expect(asListenable.value, equals(42));
    });
  });
}
