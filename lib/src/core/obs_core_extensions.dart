...
extension ObservableT<T> on T {
  ...
  ObservableAsync<T> get obsA => ObservableAsync(this);

  ObservableReadOnly<T> get obsReadOnly => ObservableReadOnly<T>(this);
  ObservableAsync<T> get obsAReadOnly =>
...
extension ListExtension<T> on List<T> {
  ...
  ObservableAsync<List<T>> get obsA => ObservableAsync(this);

  ObservableReadOnly<List<T>> get obsReadOnly =>
      ObservableReadOnly<List<T>>(this);

  ObservableAsync<List<T>> get obsAReadOnly =>
      ObservableAsync<List<T>>(this);
}
